...
type FileDictionaryV2 struct {
	// A map of dir path to dir ID.
	Dirs map[string]uint64 `protobuf:"bytes,1,rep,name=dirs,proto3" json:"dirs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// A map of dir ID to file dictionary.
	DirFiles             map[uint64]*FileDictionary `protobuf:"bytes,2,rep,name=dir_files,json=dirFiles,proto3" json:"dir_files,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}

func (m *FileDictionaryV2) Reset()         { *m = FileDictionaryV2{} }
func (m *FileDictionaryV2) String() string { return proto.CompactTextString(m) }
func (*FileDictionaryV2) ProtoMessage()    {}
func (*FileDictionaryV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_a483860494a778a2, []int{3}
}
func (m *FileDictionaryV2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileDictionaryV2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FileDictionaryV2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FileDictionaryV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileDictionaryV2.Merge(m, src)
}
func (m *FileDictionaryV2) XXX_Size() int {
	return m.Size()
}
func (m *FileDictionaryV2) XXX_DiscardUnknown() {
	xxx_messageInfo_FileDictionaryV2.DiscardUnknown(m)
}

var xxx_messageInfo_FileDictionaryV2 proto.InternalMessageInfo

func (m *FileDictionaryV2) GetDirs() map[string]uint64 {
	if m != nil {
		return m.Dirs
	}
	return nil
...
func (m *FileDictionaryV2) GetDirFiles() map[uint64]*FileDictionary {
	if m != nil {
		return m.DirFiles
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*FileDictionaryV2)(nil), "encryptionpb.FileDictionaryV2")
	proto.RegisterMapType((map[uint64]*FileDictionary)(nil), "encryptionpb.FileDictionaryV2.DirFilesEntry")
	proto.RegisterMapType((map[string]uint64)(nil), "encryptionpb.FileDictionaryV2.DirsEntry")
...
var fileDescriptor_a483860494a778a2 = []byte{
	...
	,
}
...
func (m *FileDictionaryV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FileDictionaryV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileDictionaryV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Dirs) > 0 {
		for k := range m.Dirs {
			v := m.Dirs[k]
			baseI := i
			i = encodeVarintEncryptionpb(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
			i -= len(k)
			copy(dAtA[i:], k)
...
func (m *FileDictionaryV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.Dirs) > 0 {
		for k, v := range m.Dirs {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovEncryptionpb(uint64(len(k))) + 1 + sovEncryptionpb(uint64(v))
			n += mapEntrySize + 1 + sovEncryptionpb(uint64(mapEntrySize))
		}
	}
	if len(m.DirFiles) > 0 {
		for k, v := range m.DirFiles {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *FileDictionaryV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileDictionaryV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileDictionaryV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Dirs[mapkey] = mapvalue
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DirFiles", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DirFiles == nil {
				m.DirFiles = make(map[uint64]*FileDictionary)
			}
			var mapkey uint64
			var mapvalue *FileDictionary
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
